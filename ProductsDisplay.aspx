...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <Columns>
        ...
        <asp:HyperLinkField HeaderText="PayementLinks" NavigateUrl="~/Payment.aspx" Text="Buy" />
    </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PROJECTDBConnectionString4 %>" SelectCommand="SELECT * FROM [ProductList]"></asp:SqlDataSource>
    <br />
</asp:Content>
